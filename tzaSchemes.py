...
class my_obj_finder:
    ...
    def look_for_objects(self):
        ...
        for page_number in self.pages:
            ...
            image_r.save(f"output_{page_number:03d}.png")   #добавить папочку для сохранения картинок, а потом для удаления картинок
            image_path = f"output_{page_number:03d}.png"
